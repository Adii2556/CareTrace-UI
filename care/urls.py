...
urlpatterns = [
    ...
    path("referrals/<int:referral_id>/select-records/", views.select_records, name="select_records"),
    path("referrals/<int:referral_id>/consent/", views.patient_consent, name="patient_consent"),
    path("referrals/<int:referral_id>/tracking/", views.referral_tracking, name="referral_tracking"),
    path("referrals/<int:referral_id>/workspace/", views.doctor_workspace, name="doctor_workspace"),
    path("referrals/<int:referral_id>/status/", views.update_referral_status, name="update_referral_status"),
